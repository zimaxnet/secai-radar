# SecAI Radar - Complete User Journey Design

> **Purpose:** Design the complete user journey from first visit to assessment completion, ensuring a professional, guided experience for consultants and customers.
...
### Assessment States
1. **Not Started:** Assessment created but not begun
2. **In Progress:** Assessment actively being worked on
3. **Review:** Assessment complete, under review
4. **Complete:** Assessment finalized and reported

### Control States
1. **Not Started:** Control not yet assessed
2. **In Progress:** Control being assessed
3. **Complete:** Control assessment finished
4. **Not Applicable:** Control doesn't apply to this environment
...
### Phase 1: Core Journey (MVP)
1. ✅ Landing page with SecAI Framework explanation
2. ✅ Tenant selection/creation
3. ✅ Assessment setup wizard
4. ✅ Assessment overview dashboard
5. ✅ Domain assessment pages
6. ✅ Control detail pages
7. ✅ Progress tracking
...
1. ⏳ Resume/continue functionality
...
1. Create landing page with SecAI Framework introduction
2. Create tenant selection/creation flow
3. Create assessment setup wizard
4. Enhance assessment overview with progress tracking
5. Add breadcrumb navigation
6. Add "Continue Assessment" functionality
7. Create assessment review and completion flow
8. Add report generation UI
