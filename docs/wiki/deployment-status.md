...
### Quick Links
- [Quick Start Guide](docs/wiki/QUICK-START.md) - Get started in 5 steps
- [Full Deployment Guide](docs/wiki/deployment-new-approach.md) - Complete setup instructions
- [Migration Guide](docs/wiki/MIGRATION-GUIDE.md) - Migration steps and details
...
1. Get Function App publish profile (see [Quick Start](docs/wiki/QUICK-START.md) Step 2)
