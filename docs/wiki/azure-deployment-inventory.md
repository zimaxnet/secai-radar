...
## Data Sources
- [`docs/CURRENT-STATUS.md`](docs/wiki/CURRENT-STATUS.md)
- [`docs/DEPLOYMENT-STATUS-SUMMARY.md`](docs/wiki/DEPLOYMENT-STATUS-SUMMARY.md)
- [`docs/COST-ESTIMATION.md`](docs/wiki/COST-ESTIMATION.md)
- [`docs/azure-portal-config.md`](docs/wiki/azure-portal-config.md)
