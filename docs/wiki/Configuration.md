...
See [Model Integration](docs/wiki/model-integration.md) for detailed configuration.
...
**Related**: [Installation](/wiki/Installation) | [Model Integration](docs/wiki/model-integration.md)
