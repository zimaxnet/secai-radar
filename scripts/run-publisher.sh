#!/bin/bash
# Run Publisher (T-076 / T-051). Validates latest_scores_staging and flips to latest_scores when staging is used.
set -e
cd "$(dirname "$0")/.."
...
"$VENV/bin/python" apps/workers/publisher/src/publisher.py
